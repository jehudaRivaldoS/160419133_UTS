...
import com.example.a160419133_uts.view.MainActivity
...
class NotificationHelper(val context: Context) {
    ...
    private fun notificationChanel()
    {
        ...
        {
            val channel=
                NotificationChannel(CHANNEL_ID,CHANNEL_ID, NotificationManager.IMPORTANCE_DEFAULT).apply { //apply akan dijalankan ketika tidak null
